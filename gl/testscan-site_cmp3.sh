...
cp /var/cache/consistency-dump/T2_BR_UERJ_2026_02_26_22_44_root_file_counts.json \
  ./T2_BR_UERJ_${now}_root_file_counts.json
...
export PYTHONPATH=`pwd`:`pwd`/site_cmp3:`pwd`/cmp3
...
$python cmp3/merge_config.py merge $RSE $config_file > $merged_config_file
sleep 3
ls -la $merged_config_file
...
#/var/cache/consistency-dump/T2_BR_UERJ_2026_02_26_22_44_root_file_counts.json
